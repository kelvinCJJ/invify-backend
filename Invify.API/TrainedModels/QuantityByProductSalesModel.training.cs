...
namespace Invify_API
{
    public partial class QuantityByProductSalesModel
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Forecasting.ForecastBySsa(windowSize:45,seriesLength:70,trainSize:103,horizon:20,outputColumnName:@"Quantity",inputColumnName:@"Quantity",confidenceLowerBoundColumn:@"Quantity_LB",confidenceUpperBoundColumn:@"Quantity_UB");
